...
int main() {
    ...
    std::vector <short int> vector1 {};
    std::vector <short int> vector2 {};
    ...
    // Display the elements in vector1 using the at() method as well as its size using the size() method
    std::cout << "\nVector1" << " " << vector1.at(0) << " " << vector1.at(1) << std::endl;
    ...
    // Display the elements in vector2 using the at() method as well as its size using the size() method
    std::cout << "Vector2" << " " << vector2.at(0) << " " << vector2.at(1) << std::endl;
    std::cout << "Vector2 contains " << vector2.size() << " elements" << std::endl << std::endl;

    // Declare an empty 2D vector called vector_2d
    // Remember, that a 2D vector is a vector of vector<int>
    std::vector <std::vector<short int>> vector_2d {};
    ...
    std::cout << "Vector_2d contains " << vector_2d.at(0).at(0) << " " << vector_2d.at(0).at(1) << std::endl;
    std::cout << "Vector_2d contains " << vector_2d.at(1).at(0) << " " << vector_2d.at(1).at(1) << std::endl;

    // Change vector1.at(0) to 1000
    vector1.at(0) = 1000; // just a copy not reference or pointer
